...
const TOPIC_ICONS = {
  [ALL_TOPICS]: { color: '#7c82f4', shapes: [
  ...
  'Служебные слова': { color: '#64748b', shapes: [
    { tag: 'rect', x: 5, y: 10, width: 6, height: 4, rx: 2 },
    { tag: 'rect', x: 13, y: 10, width: 6, height: 4, rx: 2 },
    { tag: 'path', d: 'M11 12h2', fill: 'none', stroke: true },
  ] },
