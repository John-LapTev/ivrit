export const APP_VERSION = 'ivrit-v13';   // версия обязана совпадать с CACHE в sw.js
...
/* Уровни и экзамен */
/** Доля верных, при которой шаг занятия засчитан: ошибиться в новом материале — норма. */
export const STEP_PASS_SHARE = 80;

export const MAX_LEVEL = 3;

/** Псевдотема «весь словарь» в выборе темы: значение, а не значок — потому и здесь. */
...
// Рукописное начертание под печатным — по умолчанию ВКЛЮЧЕНО: в Израиле от руки пишут
// курсивом, и человек, знающий только печатные буквы, не прочитает ни записку, ни ценник
export const SCRIPT_SHOWN_DEFAULT = true;
