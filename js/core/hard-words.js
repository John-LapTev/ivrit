...
/* ═══════════════════ HARD — трудные слова ═══════════════════
   Отзыв 03.09.2026: «какие-то слова я помню сразу, а какие-то угадываю методом исключения».
 ...
 * был полным (прямая просьба: «осталось 3 — беру ещё 7 рандомно из прошедших»).
 */
export function hardBatch(modeId) {
  /* В заход идут только слова, которые человек действительно проходил. Кружок стоит
     ...
     как слово для повторения (отзыв 03.09.2026: «слова „сын“ у нас вообще не было»).
