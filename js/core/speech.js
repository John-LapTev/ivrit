...
export const VOICE_COST = {
  usd: 1.81,           // синтез речи через Media Flow, суммарно за всё время
  rate: 86.47,         // ₽ за доллар, официальный курс ЦБ РФ
  updated: '09.09.2026',
  clips: 1123,        // записей: слова, примеры, фразы программы, грамматика, разговоры, слоги
};
